...
type Photo struct {
	...
	UploadedFrom    *uuid.UUID `json:"uploaded_from" gorm:"type:char(36);index"`
	UploadSessionID *uuid.UUID `json:"upload_session_id" gorm:"type:char(36)"`
...
type Album struct {
	...
	CoverPhotoID *uuid.UUID     `json:"cover_photo_id" gorm:"type:char(36)"`
...
type AlbumPhoto struct {
	ID        uuid.UUID      `json:"id" gorm:"type:char(36);primary_key"`
	AlbumID   uuid.UUID      `json:"album_id" gorm:"type:char(36);not null;index"`
	PhotoID   uuid.UUID      `json:"photo_id" gorm:"type:char(36);not null;index"`
	AddedBy   uuid.UUID      `json:"added_by" gorm:"type:char(36);not null"`
